...
console.log("after updating ",userDetails);
  ...
  const saveUpdatedDetails = async(e)=>{
    e.preventDefault();
    ...
    <div class="lg:w-[80%] md:w-[90%] xs:w-[96%] mx-auto flex gap-4">
        <div
            ...
            <div class="">
                ...
                <form onSubmit={(e)=>{saveUpdatedDetails(e)}}>
                    <div
                    ...
                    <div class="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                        <div class="w-full  mb-4 mt-6">
                            <label for="" class="mb-2 dark:text-gray-300">User Name</label>
                        ...
                        <div class="w-full  mb-4 lg:mt-6">
                            <label for="" class=" dark:text-gray-300">Mobile Number</label>
                    ...
                    <div class=" rounded-lg bg-gray-50 mt-4 text-black text-lg font-semibold">
                        <button type="submit" class=" p-4">cancel</button>

                    </div>
                    <div class=" rounded-lg bg-green-400 mt-4 text-white text-lg font-semibold">
                        <button type="submit" class=" p-4">save</button>
